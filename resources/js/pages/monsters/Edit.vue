...
import type { BreadcrumbItem, Category, Element, Image, Location, Monster, Race } from '@/types';
...
const form = useForm({
    ...
    health_points: props.monster.health_points,
    element_strength: props.monster.element_strength,
    is_aggressive: props.monster.is_aggressive,
    is_elite: props.monster.is_elite,
    is_boss: props.monster.is_boss,
    pick_up_loot: props.monster.pick_up_loot,
    shield: props.monster.shield,
    defence: props.monster.defence,
    experience: props.monster.experience,
    xp_per_hp: props.monster.xp_per_hp,
    combat_mode: props.monster.combat_mode,
    quest_only: props.monster.quest_only,
    race_id: props.monster.race.id,
    element_id: props.monster.element.id,
    image_id: props.monster.image.id,
    big_image_id: null,
    locations: props.monster.locations,
    categories: props.monster.categories,
})

const submit = () => {
    form.post(route('monsters.update', props.monster.id), {
        onSuccess: () => {
...
<template>
    <Head title="Изменение монстра" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="px-4 py-6">
            <Heading title="Изменение монстра" />
                ...
                <div class="flex flex-col space-y-8 md:space-y-0 lg:flex-row lg:space-y-0 lg:space-x-12">
                    <div class="flex-1 md:max-w-2xl">
                        <section class="max-w-xl space-y-6">
                            ...
                            <div class="gap-2">
                                <NumberField invert-wheel-change id="level" v-model="form.level" :default-value="1" :min="1" :max="70">
