...
import { type BreadcrumbItem, Category, Image, Location, NpcGroup } from '@/types';
...
<template>
    <Head title="Добавление НПС" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="px-4 py-6">
            <Heading title="Добавление НПС" />
