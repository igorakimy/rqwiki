...
import type { Bonus, BreadcrumbItem, Category, CharacterClass, EquipmentType, Image } from '@/types';
...
<template>
    <Head title="Добавление экипировки" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="px-4 py-6">
            <Heading title="Добавление экипировки" />
