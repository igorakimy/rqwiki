    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <SettingsLayout>
            <div class="flex flex-col space-y-6">
                <HeadingSmall title="Информация профиля" description="Обновление имени и email адреса" />
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div v-if="mustVerifyEmail && !user.email_verified_at">
                        <p class="-mt-4 text-sm text-muted-foreground">
                            Ваш email адрес не верифицирован.
                            <Link
                            ...
                            >
                                Кликните здесь, чтобы получить повторно письмо для верификации.
                            </Link>
                        </p>

                        <div v-if="status === 'verification-link-sent'" class="mt-2 text-sm font-medium text-green-600">
                            Новая ссылка для верификации была отправлена на Ваш email.
                        </div>
                    </div>
